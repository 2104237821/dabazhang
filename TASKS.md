...
|---|---|---|---|---|---|---|---|---|
| T00 | IN_PROGRESS | 无 | 主协调代理 | 目标、规则、架构、任务板 | main | 文档人工复核 | 待填 | 待复核 |
| T01 | BLOCKED | T00 | 主协调代理 | 根配置、`packages/protocol`、CI | codex/v1-web-game | lint、typecheck、build | 待填 | 待复核 |
| T02 | BLOCKED | T01 | Franklin | `packages/game-core` 基础 | task/T02-engine-model | game-core tests | 待填 | 待复核 |
| T03 | BLOCKED | T02 | Franklin | `packages/game-core` 规则 | task/T03-engine-rules | unit + property tests | 待填 | 待复核 |
| T04 | BLOCKED | T01 | Kuhn | `apps/server` 房间与会话 | task/T04-server-room | server tests | 待填 | 待复核 |
| T05 | BLOCKED | T01 | Hume | `apps/web` 页面壳 | task/T05-web-shell | web tests + build | 待填 | 待复核 |
